  ...
  <!-- Menu Notificação-->
    ...
    <aside class="app-sidebar">
      ...
      <ul class="treeview-menu">
           ...
           <li><a class="app-menu__item" href="{{route('Agendamento-add')}}">
        ...
        <i class="treeview-indicator fa fa-angle-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{{route('Lista-add')}}"><i class="icon fa fa-circle-o"></i> Consultar</a></li>
    ...
    <script src=" {{url('/')}}/css/dataTables.min.js"></script>

    <!-- The javascript plugin to display page loading on top-->
    <script src="{{url('/')}}/ js/plugins/pace.main.js"></script>
